                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea rows="4" name="description" id="description" class="form-control @error('description') is-invalid @enderror"></textarea>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input name="start_date" id="start_date" type="date" class="form-control @error('start_date') is-invalid @enderror">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <i class="far fa-calendar-alt icon-append"></i>
                            <input name="end_date" id="end_date" type="date" class="form-control @error('end_date') is-invalid @enderror">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
